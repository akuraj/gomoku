use consts::{SIDE_LEN, EMPTY, BLACK, WHITE, WALL, COLORS, ACT_ELEMS_TO_NAMES};
use pattern_search::search_board;
use board::{new_board, get_board, board_to_str};
use pattern::P_WIN;
use ndarray::prelude::*;
use std::fmt;
    ...
    pub fn new(board: Array2<u8>, turn: u8, strict_stone_count: bool) -> Self {
        ...
        if strict_stone_count {
            if black_total == white_total + 1 {
                ...
                panic!("Invalid number of stones: Black: {}, White: {}", black_total, white_total);
            }
        }
